...
class Likes extends React.Component {
  ...
  likeSection() {
    ...
    if (like) {
      return <a className={this.props.className} onClick={ ()=>this.handleUnlike(like)}><span className="oi oi-thumb-down"></span></a>
    } else {
      return <a className={this.props.className} onClick={ ()=>this.handleLike(parent)}><span className="oi oi-thumb-up"></span></a>
    }
  }
